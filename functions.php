...
function scentric_scripts() {
  ...
  */
  ...
  wp_register_script('jquery', get_template_directory_uri().'/js/vendor/jquery-1.8.0.js', array(), '1.8.0', false );
  ...
  wp_enqueue_script( 'edge-web-fonts', 'http://use.edgefonts.net/league-gothic.js');
